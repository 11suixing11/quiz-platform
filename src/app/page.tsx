  ...
  return (
    <div className="min-h-screen bg-[#FAFAF8] dark:bg-[#0a0a0a]">
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        ...
        >
          <h2 className="text-2xl font-bold text-[#2C2C2C] dark:text-white sm:text-3xl">从这里开始</h2>
          <p className="mt-2 text-sm text-[#2C2C2C]/60 dark:text-white/60">不知道选什么？这几个测试最受欢迎。</p>
        </motion.div>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="mt-8 text-center">
          <a href="#explore" className="inline-flex h-10 items-center justify-center rounded-full border border-[#2C2C2C]/20 dark:border-white/20 px-6 text-sm font-medium text-[#2C2C2C] dark:text-white transition-colors hover:bg-[#2C2C2C]/5 dark:hover:bg-white/5">查看全部 113 个测试 →</a>
        </motion.div>
      </section>
      ...
      <footer className="border-t border-[#2C2C2C]/8 dark:border-white/8 px-4 py-16 text-center">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="text-sm text-[#2C2C2C]/50 dark:text-white/50 mb-4">这里不是诊断，而是一面帮助你靠近自己的镜子。</p>
          <div className="flex items-center justify-center gap-6 text-xs text-[#2C2C2C]/30 dark:text-white/30">
            <Link href="/compat/" className="hover:text-[#2C2C2C]/60 dark:hover:text-white/60 transition-colors">关系配对</Link>
            <span>·</span>
            <Link href="/quiz/big-five/" className="hover:text-[#2C2C2C]/60 dark:hover:text-white/60 transition-colors">大五人格</Link>
            <span>·</span>
            <Link href="/quiz/mbti/" className="hover:text-[#2C2C2C]/60 dark:hover:text-white/60 transition-colors">MBTI</Link>
          </div>
        </div>
      </footer>
    </div>
