...
const content = {
  zh: {
    ...
    hosting: "托管说明",
    hostingText: "站点由自有服务器上的 Caddy 提供静态文件。服务器和网络服务可能按其自身政策处理标准网络请求元数据；应用本身不会把测试答案或结果加入这些请求。",
    controls: "管理本地数据",
    source: "查看源代码",
  },
  en: {
    ...
    hostingText: "The site's static files are served by Caddy on a self-managed server. The server and network providers may process standard request metadata under their own policies; the app does not add quiz answers or results to those requests.",
