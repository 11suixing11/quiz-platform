// @ts-nocheck
// Auto-converted from happiness.js
...
const HAPPINESS_TEST: any = {
    ...
    archetypes: {
        low: { world: 'dreamers', color: '#6B5B95', mood: '阴天 · 等待 · 萌芽', quote_zh: '幸福不是一种状态，而是一种能力——你现在正在培养它。', quote_en: 'Happiness is not a state but a skill — and you are building it right now.' },
        medium: { world: 'connectors', color: '#5A9B6A', mood: '晨光 · 成长 · 探索', quote_zh: '你已经拥有了幸福的基础，现在是让它绽放的时候。', quote_en: 'You already have the foundation of happiness — now is the time to let it bloom.' },
        high: { world: 'connectors', color: '#4A8B5A', mood: '阳光 · 满溢 · 感恩', quote_zh: '你正在经历一种真实的满足感，这值得被珍惜。', quote_en: 'You are experiencing a genuine sense of fulfillment — and it is worth cherishing.' }
    },
