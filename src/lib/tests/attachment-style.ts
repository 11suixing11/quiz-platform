// @ts-nocheck
// Auto-converted from attachment-style.js
...
const ATTACHMENT_STYLE_TEST: any = {
    ...
    archetypes: {
        // Connectors — 关系连接者 (绿)
        SE: { world: 'connectors', color: '#4A8B5A', mood: '港湾 · 信任 · 自由', quote_zh: '你知道爱不需要紧握，松手也不会失去。', quote_en: 'You know love does not need to be gripped tight — letting go does not mean losing.' },

        // Dreamers — 情绪感知者 (紫)
        AN: { world: 'dreamers', color: '#6B5B95', mood: '潮汐 · 等待 · 渴望', quote_zh: '你比大多数人更需要确认，因为你比大多数人更在乎。', quote_en: 'You need reassurance more than most, because you care more than most.' },
        DI: { world: 'dreamers', color: '#7B68AE', mood: '矛盾 · 拉扯 · 寻找', quote_zh: '你同时渴望和害怕亲密，这让你在关系中总是进退两难。', quote_en: 'You simultaneously crave and fear intimacy, caught between push and pull.' },

        // Analysts — 理性建筑师 (蓝)
        AV: { world: 'analysts', color: '#4A6FA5', mood: '边界 · 独立 · 距离', quote_zh: '你用距离保护自己，但有时候距离也隔绝了温暖。', quote_en: 'You protect yourself with distance, but sometimes distance also blocks warmth.' }
    },
...
export default ATTACHMENT_STYLE_TEST;
