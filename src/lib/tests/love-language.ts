// @ts-nocheck
// Auto-converted from love-language.js
...
const LOVE_LANGUAGE_TEST: any = {
    ...
    archetypes: {
        // Dreamers — 情绪感知者 (紫)
        WA: { world: 'dreamers', color: '#6B5B95', mood: '文字 · 声音 · 确认', quote_zh: '你需要听到"我爱你"，言语是你感受爱的方式。', quote_en: 'You need to hear "I love you" — words are how you feel loved.' },
        QT: { world: 'dreamers', color: '#7B68AE', mood: '陪伴 · 专注 · 在场', quote_zh: '对你来说，最好的爱是"我在这里，只属于你"。', quote_en: 'The best love for you is "I am here, and I am yours."' },

        // Connectors — 关系连接者 (绿)
        AS: { world: 'connectors', color: '#4A8B5A', mood: '行动 · 照顾 · 付出', quote_zh: '你用行动表达爱，做比说更重要。', quote_en: 'You express love through actions — doing matters more than saying.' },
        RG: { world: 'connectors', color: '#5A9B6A', mood: '象征 · 仪式 · 记忆', quote_zh: '你在乎的不是礼物本身，而是那份被记住的感觉。', quote_en: 'It is not the gift itself you care about, but the feeling of being remembered.' },

        // Explorers — 行动探索者 (橙)
        PT: { world: 'explorers', color: '#C4783C', mood: '触碰 · 温度 · 亲密', quote_zh: '你需要身体的温度来确认爱的存在。', quote_en: 'You need physical warmth to confirm that love is real.' }
    },
    ...
    uiText: {
        ...
        en: {
            ...
            disclaimer: "This test is for entertainment purposes only and is not scientifically authoritative. Love languages are ways of expressing and feeling love. For professional help, please consult a relationship counselor.",
...
export default LOVE_LANGUAGE_TEST;
