// @ts-nocheck
// Auto-converted from locus-control.js
/* eslint-disable @typescript-eslint/no-explicit-any */

const LOCUS_CONTROL_TEST: any = {
    ...
    uiText: {
        zh: { resultTitle: '你的控制点类型', disclaimer: '本测试仅供参考。', restartBtn: '重新测试', homeBtn: '返回首页', shareBtn: '分享结果', progress: '进度', question: '问题', of: '题 / 共', nextBtn: '下一题', prevBtn: '上一题', submitBtn: '提交', loading: '正在分析...', scoreLow: '外控', scoreHigh: '内控' },
...
export default LOCUS_CONTROL_TEST;
