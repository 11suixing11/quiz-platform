// @ts-nocheck
// Auto-converted from enneagram.js
...
const ENNEAGRAM_TEST: any = {
    ...
    archetypes: {
        // Dreamers — 情绪感知者 (紫)
        '4': { world: 'dreamers', color: '#6B5B95', mood: '独白 · 深渊 · 创造', quote_zh: '你活在自己的内心世界里，用独特的方式感受一切。', quote_en: 'You live in your inner world, feeling everything in your own unique way.' },
        '6': { world: 'dreamers', color: '#7B68AE', mood: '守护 · 忠诚 · 警觉', quote_zh: '你在乎安全和忠诚，总是在为最坏的情况做准备。', quote_en: 'You value safety and loyalty, always preparing for the worst.' },

        // Analysts — 理性建筑师 (蓝)
        '1': { world: 'analysts', color: '#4A6FA5', mood: '秩序 · 原则 · 完美', quote_zh: '你相信世界应该有规则，而你愿意成为那个执行规则的人。', quote_en: 'You believe the world should have rules, and you will be the one to uphold them.' },
        '5': { world: 'analysts', color: '#5A7FB5', mood: '知识 · 观察 · 独立', quote_zh: '你用知识武装自己，在独处中找到力量。', quote_en: 'You arm yourself with knowledge, finding strength in solitude.' },

        // Connectors — 关系连接者 (绿)
        '2': { world: 'connectors', color: '#4A8B5A', mood: '温暖 · 给予 · 连接', quote_zh: '你用爱定义自己，用付出证明存在的意义。', quote_en: 'You define yourself through love and prove your worth through giving.' },
        '9': { world: 'connectors', color: '#5A9B6A', mood: '和平 · 融合 · 宁静', quote_zh: '你追求内心的平静，希望所有人都能和谐共处。', quote_en: 'You seek inner peace, hoping everyone can live in harmony.' },

        // Explorers — 行动探索者 (橙)
        '3': { world: 'explorers', color: '#C4783C', mood: '成就 · 光芒 · 行动', quote_zh: '你用成就定义自己，永远在追求更高的目标。', quote_en: 'You define yourself through achievement, always pursuing higher goals.' },
        '7': { world: 'explorers', color: '#D4884C', mood: '自由 · 冒险 · 快乐', quote_zh: '你害怕被困住，所以一直在寻找新的体验和可能性。', quote_en: 'You fear being trapped, so you keep seeking new experiences and possibilities.' },
        '8': { world: 'explorers', color: '#E4985C', mood: '力量 · 控制 · 保护', quote_zh: '你用力量保护你在乎的人，用掌控感对抗不确定性。', quote_en: 'You protect those you care about with strength, fighting uncertainty with control.' }
    },
