// @ts-nocheck
// Auto-converted from introversion.js
/* eslint-disable @typescript-eslint/no-explicit-any */

const INTROVERSION_TEST: any = {
    ...
    archetypes: {
        low: { world: 'connectors', color: '#D4884C', mood: '阳光 · 聚会 · 能量', quote_zh: '你在人群中充电，社交是你的氧气。', quote_en: 'You recharge in crowds — socializing is your oxygen.' },
        medium: { world: 'connectors', color: '#9C27B0', mood: '黄昏 · 平衡 · 灵活', quote_zh: '你可以在独处和社交之间自由切换，这是一种天赋。', quote_en: 'You can switch freely between solitude and socializing — a true gift.' },
        high: { world: 'dreamers', color: '#6B5B95', mood: '月光 · 独处 · 深度', quote_zh: '你从安静中汲取力量，在独处中找到自己。', quote_en: 'You draw strength from quiet, finding yourself in solitude.' }
    },
    ...
    uiText: {
        zh: { resultTitle: '你的内向指数', disclaimer: '本测试仅供参考。', restartBtn: '重新测试', homeBtn: '返回首页', shareBtn: '分享结果', progress: '进度', question: '问题', of: '题 / 共', nextBtn: '下一题', prevBtn: '上一题', submitBtn: '提交', loading: '正在分析...', scoreLow: '外向', scoreHigh: '内向' },
...
export default INTROVERSION_TEST;
