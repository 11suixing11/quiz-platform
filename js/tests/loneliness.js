    ...
    resultTypes: {
        low: {
            zh: {
                ...
                suggestions: ["继续保持现有的社交关�?, "定期与朋友和家人联系", "拓展新的社交�?, "帮助他人建立社交联系"]
            },
            en: {
        ...
        medium: {
            zh: {
                ...
                suggestions: ["主动参加社交活动", "培养新的兴趣爱好", "加入社区或志愿者组�?, "尝试与老朋友重新建立联�?],
                range: [31, 60]
            },
            en: {
        ...
        high: {
            zh: {
                ...
                suggestions: ["寻求专业心理咨询", "从小的社交互动开�?, "参加支持小组", "考虑养宠物作为陪�?, "学习社交技�?],
                range: [61, 100]
            },
            en: {
