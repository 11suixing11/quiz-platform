    ...
    types: {
        INTJ: {
            zh: {
                ...
                strengths: ["战略思维", "独立自主", "高效�?, "有远�?],
                weaknesses: ["过于理�?, "不善表达情感", "完美主义", "社交困难"]
            },
            en: {
                name: "Architect",
        ...
        INTP: {
            zh: {
                ...
                strengths: ["逻辑分析", "创新思维", "独立思�?, "求知欲强"],
                weaknesses: ["拖延�?, "不善社交", "过于理论�?, "忽视细节"]
            },
            en: {
                name: "Logician",
                title: "INTP - Logician",
        ...
        ENTJ: {
            zh: {
                ...
                strengths: ["领导能力", "战略眼光", "果断决策", "高效�?],
                weaknesses: ["过于强势", "缺乏耐心", "忽视他人感受", "工作�?]
            },
            en: {
                name: "Commander",
        ...
        INFJ: {
            zh: {
                ...
                strengths: ["洞察�?, "同理�?, "有远�?, "有责任感"],
                weaknesses: ["过于理想�?, "敏感", "完美主义", "容易疲惫"]
            },
            en: {
                name: "Advocate",
                title: "INFJ - Advocate",
        ...
        INFP: {
            zh: {
                ...
                strengths: ["创造力", "同理�?, "忠诚", "有理�?],
                weaknesses: ["过于理想�?, "敏感", "不切实际", "容易自责"]
            },
            en: {
                name: "Mediator",
                title: "INFP - Mediator",
        ...
        ENFJ: {
            zh: {
                ...
                strengths: ["领导能力", "同理�?, "有魅�?, "善于激�?],
                weaknesses: ["过于理想�?, "忽视自己", "过于敏感", "控制�?]
            },
            en: {
                name: "Protagonist",
        ...
        ENFP: {
            zh: {
                ...
                strengths: ["创造力", "热情", "适应力强", "善于激�?],
                weaknesses: ["缺乏专注", "过于理想�?, "情绪�?, "难以坚持"]
            },
            en: {
                name: "Campaigner",
        ...
        ISTJ: {
            zh: {
                ...
                strengths: ["责任�?, "有条�?, "可靠", "注重细节"],
                weaknesses: ["过于死板", "不善变�?, "忽视他人感受", "过于传统"]
            },
            en: {
                name: "Logistician",
        ...
        ESTJ: {
            zh: {
                ...
                weaknesses: ["过于专制", "不善变�?, "忽视他人感受", "过于传统"]
            },
            en: {
                name: "Executive",
        ...
        ESFP: {
            zh: {
                ...
                strengths: ["感染�?, "社交能力", "乐观", "热情"],
                weaknesses: ["缺乏规划", "注意力分�?, "冲动", "难以坚持"]
            },
            en: {
                name: "Entertainer",
