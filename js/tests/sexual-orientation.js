/**
 * 性取向测试题�? * Sexual Orientation Test
 */
...
var SEXUAL_ORIENTATION_TEST = {
    ...
    questions: [
        ...
        },
        {
            ...
            options: {
                zh: ["一定是异性角�?, "偏向异性角�?, "都可�?, "偏向同性角�?, "一定是同性角�?],
        ...
        },
        {
            ...
            options: {
                zh: ["完全是异�?, "偏向异�?, "两�?equally", "偏向同�?, "完全是同�?],
        ...
        },
        {
            ...
            options: {
                zh: ["完全是异性特�?, "偏向异性特�?, "都可�?, "偏向同性特�?, "完全是同性特�?],
                en: ["Exclusively opposite gender", "Mostly opposite gender", "Both equally", "Mostly same gender", "Exclusively same gender"]
            },
            scores: [0, 1, 2, 3, 4]
        },
