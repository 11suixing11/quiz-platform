...
var LOVE_LANGUAGE_TEST = {
    type: 'love-language',
    icon: '💕',
    color: '#E91E63',
    questions: [
        // Words of Affirmation (肯定言�?
        {
            id: 1,
            dimension: 'WA',
            zh: "当伴侣对我说'我爱�?时，我感到最被爱�?,
    ...
    languages: {
        WA: {
            zh: {
                ...
                tips: ["多对伴侣�?我爱�?", "经常赞美和肯定伴�?, "写情书或发甜蜜短�?, "在别人面前夸奖伴�?]
            },
            en: {
        ...
        AS: {
            zh: {
                name: "服务行动",
                description: "你的主要爱情语言是服务行动。对你来说，伴侣通过实际行动来表达爱意是最能让你感到被爱的方式�?行动胜于言�?是你的信条�?,
                tips: ["主动帮助伴侣做家�?, "为伴侣准备食�?, "主动解决问题", "分担伴侣的工�?]
            },
            en: {
        ...
        RG: {
            zh: {
                ...
                tips: ["记住特殊日子并送礼�?, "即使是很小的礼物也很重要", "让礼物代表你的思念", "不要忘记重要纪念�?]
            },
            en: {
        ...
        QT: {
            zh: {
                ...
                tips: ["安排专属的约会时�?, "放下手机，全神贯注陪�?, "一起散步、聊天或看电�?, "主动安排有意义的活动"]
            },
            en: {
                name: "Quality Time",
        ...
        PT: {
            zh: {
                ...
                tips: ["多拥抱和亲吻伴侣", "牵手或依偎在一�?, "用身体接触表达支�?, "保持亲密的身体接�?]
            },
            en: {
                name: "Physical Touch",
