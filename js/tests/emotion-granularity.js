    ...
    resultTypes: {
        low: {
            zh: {
                title: "低情绪粒�?,
                name: "低情绪粒�?,
                description: "你的情绪粒度较低。你可能更多地用简单的词语（如�?不好）来描述自己的情绪，而较少区分不同情绪之间的细微差异。提升情绪粒度可以帮助你更好地理解自己和管理情绪�?,
                suggestions: ["学习更多的情绪词�?, "尝试用日记记录情绪变�?, "练习区分相似情绪之间的差�?, "阅读关于情绪心理学的书籍"]
            },
            en: {
        ...
        medium: {
            zh: {
                ...
                suggestions: ["每天练习识别和命名自己的情绪", "与他人讨论情绪体�?, "使用情绪轮盘等工�?, "注意身体对不同情绪的反应"],
                range: [31, 60]
            },
            en: {
        ...
        high: {
            zh: {
                ...
                suggestions: ["继续保持对情绪的精细觉察", "帮助他人提升情绪识别能力", "将情绪觉察应用于日常决策", "继续扩展情绪词汇�?],
                range: [61, 100]
            },
            en: {
