...
For a Gmail account with a 16-character application password, run the helper from a local PowerShell 7 session:

```powershell
$env:DEPLOY_HOST='your-vps-host-or-address'
$env:ADMIN_KEY="$HOME\.ssh\your-deploy-key"
pwsh -NoProfile -ExecutionPolicy Bypass -File .\deploy\configure-gmail-smtp.ps1 -Email 'you@gmail.com'
```
